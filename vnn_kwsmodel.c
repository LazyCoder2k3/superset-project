...
vsi_nn_graph_t * vnn_CreateKwsModel
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @serving_default_x/0_0:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 3960;
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0037071078550070524;
    attr.dtype.zero_point = -128;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_NORM_TENSOR(norm_tensor[0], attr, VSI_NN_TYPE_INT8);

    /* @StatefulPartitionedCall/0_106:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 2;
    attr.size[1] = 1;
    attr.dim_num = 2;
...
error:
    ...
    vnn_ReleaseKwsModel( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateKwsModel() */

void vnn_ReleaseKwsModel
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )

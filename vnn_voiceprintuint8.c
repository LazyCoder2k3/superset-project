...
vsi_nn_graph_t * vnn_CreateVoiceprintUint8
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_embedding_out_0/out0_0:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 128;
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0017355455784127116;
    ...
    attr.size[2] = 1;
    attr.dim_num = 3;
    attr.dtype.scale = 0.31372547149658203;
...
error:
    ...
    vnn_ReleaseVoiceprintUint8( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateVoiceprintUint8() */

void vnn_ReleaseVoiceprintUint8
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
